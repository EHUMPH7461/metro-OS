...
export function AnalyticsPage(){
 ...
 return <section className="analytics-page">
  <header><div><p className="eyebrow">METRO COMMAND CENTER</p><h1>Business Analytics</h1><p>Operational insight from persisted inventory, listings, photos, storage, and sales.</p></div><span className="version-pill">v0.5.0</span></header>
