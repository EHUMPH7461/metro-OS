...
Version `0.5.0` is the current Windows release candidate. It packages the inventory, Photo Manager, Listing Workspace, Analytics, Action Center, and offline AI Listing Assistant workflows on Electron 43.2.0. See [RC1 preparation](docs/RELEASE_CANDIDATE_v0.5.0_RC1.md) and [RC1 release notes](docs/RELEASE_NOTES_v0.5.0_RC1.md). It is not a final release or tag.
